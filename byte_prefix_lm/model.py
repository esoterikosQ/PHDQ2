"""Small byte-level Prefix-LM baseline.

This is not Byte Latent Transformer: it has no entropy patcher, no local
encoder/global latent transformer/local decoder split, and no dynamic patching.
It is kept only as a byte-only causal Transformer baseline.
"""
...
from byte_prefix_lm.data_adapter import PAD_ID, VOCAB_SIZE
...
class BytePrefixTransformerLM(nn.Module):
    """Causal byte Transformer baseline."""
