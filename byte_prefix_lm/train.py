"""Train the byte-level Prefix-LM baseline.

This is not BLT. It is the earlier byte-only causal Transformer kept for
baseline/smoke-test runs.
"""
...
from byte_prefix_lm.data_adapter import GecBltDataset, IGNORE_INDEX, PAD_ID
...
def parse_args():
    parser = argparse.ArgumentParser(description="Byte Prefix-LM GEC baseline training")
    parser.add_argument("--data", type=str, default="native")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--train_data_path", type=str, default="")
    parser.add_argument("--val_data_path", type=str, default="")
    parser.add_argument("--test_data_path", type=str, default="")
    parser.add_argument("--output_dir", type=str, default="outputs/byte_prefix_lm")
